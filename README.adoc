...
:url-gitlab: https://gitlab.com/hyperpolymath/hybrid-automation-router
:url-bitbucket: https://bitbucket.org/hyperpolymath/hybrid-automation-router
:url-codeberg: https://codeberg.org/hyperpolymath/hybrid-automation-router

Hybrid cloud automation routing engine
...
hybrid-automation-router is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
